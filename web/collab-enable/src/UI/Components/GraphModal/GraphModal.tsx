...
export const GraphModal: FunctionComponent<GraphModalProps> = ({ open, onClose, data, onDonwloadButtonClick }) => {

  const { moveEvents, dragEvents, clickEvents, doubleClickEvents, rightClickEvents, allEvents } = useMemo(() => {
      ...
      <div className="GraphModal">
        <div className="GraphModal__header">
          <div className="GraphModal__header__left--area">
            <Button onClick={onDonwloadButtonClick}>Télécharger le CSV en local</Button>
            <Button variant="white">Envoyer le CSV sur le cloud Google</Button>
          </div>
          <button className="GraphModal__close--button" onClick={onClose}>
            <IconX />
          </button>
        </div>
